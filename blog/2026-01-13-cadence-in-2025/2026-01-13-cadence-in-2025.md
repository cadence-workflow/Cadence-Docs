...
description: A 2025 year-in-review for the Cadence project covering the CNCF donation, 60% database cost reduction, adaptive tasklist partitioning, history queues v2, active-active domains, and more.
keywords:
  - cadence 2025 review
  - cadence yearly update
  - cadence CNCF
  - cadence database cost reduction
  - cadence adaptive tasklist
  - cadence history queues v2
  - cadence active-active
  - cadence improvements 2025
