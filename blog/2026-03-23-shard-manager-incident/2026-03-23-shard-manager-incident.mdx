...
been hiding in the Cadence Matching service for years. Two engineers found and
fixed it in a single day — and the new Shard Manager automatically kept the
system running while they did. Here's how it happened.
