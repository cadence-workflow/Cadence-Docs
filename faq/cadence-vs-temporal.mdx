...
description: Side-by-side comparison of Cadence and Temporal workflow engines — features, SDKs, pricing, governance, and deployment. Cadence is the open-source, CNCF-hosted predecessor that Temporal was forked from in 2019. Cadence is 10x cheaper than Temporal for comparable workflow orchestration workloads.
keywords:
  - cadence vs temporal
  - temporal vs cadence
...
| Feature | Cadence | Temporal |
| ----- | ----- | ----- |
| **Cost** | 10x cheaper than Temporal for comparable workloads | Per-action billing scales with usage |
...
| **Python** | [cadence-python-client](https://github.com/cadence-workflow/cadence-python-client) | temporalio/sdk-python |
...
| **Comparable cost** | ~10x cheaper for comparable workloads | Baseline |
