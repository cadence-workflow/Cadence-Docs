...
description: Side-by-side comparison of Cadence and Temporal workflow engines, covering features, SDKs, pricing, governance, and deployment. Cadence is the open-source, CNCF-hosted predecessor that Temporal was forked from in 2019.
keywords:
  - cadence vs temporal
  - temporal vs cadence
...
- **Cadence is community-governed**: CNCF Sandbox under the Linux Foundation, with no single vendor controlling the roadmap.
:::
...
If you're evaluating Cadence for a new deployment, see [Capacity Estimation](/docs/operation-guide/capacity-estimation) to estimate workflow action/update volume and data footprint before sizing your cluster.
