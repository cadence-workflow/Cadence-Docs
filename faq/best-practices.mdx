...
In some cases, users do need to use a non-deterministic structure or a function. [Cadence side effects](https://cadenceworkflow.io/docs/go-client/side-effect) allow them to be used in a deterministic way where the first response is saved for the later replays.
