...
```bash
docker run -it --rm ubercadence/cli:master --address host.docker.internal:7833 --domain samples-domain domain describe
```
...
% cadence --address $(hostname -i):7833 --do samples-domain domain register
```
