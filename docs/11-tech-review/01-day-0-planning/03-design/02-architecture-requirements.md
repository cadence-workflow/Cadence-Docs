...
- Outbound network access to Frontend, the service name `cadence-frontend`, a domain, and a task list. Go and Java support gRPC (`7833`) or TChannel (`7933`); Python uses gRPC.
