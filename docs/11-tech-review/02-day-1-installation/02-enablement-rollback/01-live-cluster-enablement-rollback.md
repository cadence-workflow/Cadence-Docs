...
You can install or remove the project as ordinary Deployments (or VMs, or Compose), and the host cluster's control plane is unaffected. Related pages: [Installation and initialization](/docs/tech-review/day-0-planning/installation/installation-initialization) for how Cadence is first brought up, [Service dependencies](/docs/tech-review/day-0-planning/design/service-dependencies) for what else must be running, [Default behaviors](/docs/tech-review/day-1-installation/enablement-rollback/default-behaviors) for what turning Cadence on does not change in Kubernetes, and [Rollback procedures](/docs/tech-review/day-1-installation/rollout-upgrade-rollback/rollback-procedures) for **version** downgrades after an upgrade, which is a different operation.
