...
description: This page outlines the many ways to get involved with the Cadence project, from using and testing Cadence to contributing code, reviewing PRs, writing content, or becoming a partner.
keywords:
  - ways to contribute cadence
  - cadence community roles
  - cadence developer contributor
  - cadence bug reporter
  - cadence alpha tester
  - cadence partner
  - cadence champion
  - cadence reviewer
  - cadence open source involvement
date: 2025-01-07
