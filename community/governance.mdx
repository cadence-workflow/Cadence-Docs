---
title: Governance
description: This page describes the Cadence project governance model, including official roles like maintainer and TSC member, contribution guidelines, and the voting process for decisions.
keywords:
  - cadence governance
  - cadence maintainer
  ...
  - cadence TSC
  - cadence roles
  - cadence voting process
  - cadence open source governance
  - cadence contribution guidelines
date: 2025-05-09
...
The roadmap is published and updated regularly on the [GitHub Roadmap Project](https://github.com/orgs/cadence-workflow/projects/1) where high-level details are posted on our [project website](/).
